...
export default function index() {
  ...
  <>
    ...
    <div className="container">
      <Link className="navbar-brand" to="./index.html"><img className="w-100" src="../public/assets/img/icon/logo.svg" alt=""/></Link>
    ...
    <div className="container">
      <div className="intro pb-5">
        ...
        <div className="intro-img">
            <img src="../public/assets/img/header-img.png" alt=""/>
        </div>
        <div className="scroll">
          <Link to="#variations"><img src="../public/assets/img/icon/icon-scroll-down.svg" alt=""/><span className="text-muted">Scroll down</span></Link>
        </div>
      </div>
      ...
      <div className="clients text-center">
        ...
        <div className="client-logo">
          <div><img src="../public/assets/img/icon/go-sm-logo.svg" alt=""/></div>
          <div><img src="../public/assets/img/icon/social-road-logo.svg" alt=""/></div>
          <div><img src="../public/assets/img/icon/firmbee-logo.svg" alt=""/></div>
          <div><img src="../public/assets/img/icon/create-paper.svg" alt=""/></div>
          <div><img src="../public/assets/img/icon/point-design-logo.svg" alt=""/></div>
        </div>
      </div>
      ...
      <div id="variations" className="variations">
        <div className="first-variation">
          <div className="img">
            <img src="../public/assets/img/man.png" alt=""/>
          </div>
          <div className="text">
        ...
        <div className="second-variation">
          ...
          <div className="img">
            <img src="../public/assets/img/woman.png" alt=""/>
            <img className = "square" src="../public/assets/img/icon/square.png" alt=""/>
          </div>
        </div>
      </div>
      ...
      <div className="service">
        ...
        <div className="service-items">
          <div className="item">
            <img src="../public/assets/img/icon/code-icon.svg" alt=""/>
            <span className="counter">7 453 664</span>
            <span>Kilometers <br/>of code written</span>
          </div>
          <div className="item">
            <img src="../public/assets/img/icon/cofee-icon.svg" alt=""/>
            <span className="counter">43 657</span>
            <span>Coffees<br/>drunk</span>
          </div>
          <div className="item">
            <img src="../public/assets/img/icon/satisfied-client-icon.svg" alt=""/>
            <span className="counter">1 764</span>
            <span>Satisfied<br/>customers</span>
          </div>
          <div className="item">
            <img src="../public/assets/img/icon/realized-projects-icon.svg" alt=""/>
      ...
      <div className="team text-center">
        ...
        <div className="team-person">
          <div className="person">
            <div className="photo"><img src="../public/assets/img/team-1.png" alt=""/></div>
            <span className="name">John Fox</span>
            <span>Marketing Manager</span>
          </div>
          <div className="person">
            <div className="photo"><img src="../public/assets/img/team-2.png" alt=""/></div>
            <span className="name">Kate Rose</span>
            <span>SEO</span>
          </div>
          <div className="person">
            <div className="photo"><img src="../public/assets/img/team-3.png" alt=""/></div>
            <span className="name">Anna Brown</span>
            <span>UI Expert</span>
          </div>
          <div className="person">
            <div className="photo"><img src="../public/assets/img/team-4.png" alt=""/></div>
