        ...
        <div className="container">
          ...
          <div className="service">
            ...
            <div className="service-items">
              <div className="item">
                <img  draggable="false" src="/assets/img/icon/code-icon.svg" alt="" />
              ...
              <div className="item">
                <img  draggable="false" src="/assets/img/icon/cofee-icon.svg" alt="" />
              ...
              <div className="item">
                <img  draggable="false" src="/assets/img/icon/satisfied-client-icon.svg" alt="" />
              ...
              <div className="item">
                <img  draggable="false" src="/assets/img/icon/realized-projects-icon.svg" alt="" />
                <span className="counter">10</span>
                <span>
                  Realized
                  <br />
          ...
          <div className="team text-center">
            ...
            Our team comprises seasoned professionals in various domains including software development, UX/UI design, digital design, marketing, project management, and more. With a wealth of experience, we bring a deep understanding of diverse industries to every project.
